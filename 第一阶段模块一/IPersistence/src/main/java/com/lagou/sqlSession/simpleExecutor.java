...
public class simpleExecutor implements Executor {
    ...
    public <E> List<E> query(Configuration configuration, MappedStatement mappedStatement, Object... params) throws Exception {
        PreparedStatement preparedStatement = sqlParameterInit(configuration, mappedStatement, params);
        // 5. 执行sql
    ...
    public void insert(Configuration configuration, MappedStatement mappedStatement, Object... params) throws Exception {
        ...
        System.out.println("添加数据："+updateCount);
    ...
    public void update(Configuration configuration, MappedStatement mappedStatement, Object... params) throws Exception {
        ...
        System.out.println("更新數據：" + resultSet);
    ...
    public void delete(Configuration configuration, MappedStatement mappedStatement, Object... params) throws Exception {
        ...
        // 5. 执行sql
        int resultSet = preparedStatement.executeUpdate();
        System.out.println("删除数据：" + resultSet);
    }


    private PreparedStatement sqlParameterInit(Configuration configuration, MappedStatement mappedStatement, Object[] params) throws Exception {
        // 1. 注册驱动，获取连接
